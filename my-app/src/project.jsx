...
function ProjectCard({ item }) {
  return (
    <div className="bg-white/5 rounded-xl p-5 shadow-lg flex flex-col gap-3 border border-white/10 hover:shadow-2xl transition">
      <picture>
        <source srcSet={item.img} type="image/avif" />
        <img
          src={item.img}
      ...
      <p className="text-gray-300 text-sm flex-1">{item.pra}</p>
...
export default function Program() {
  ...
  return (
    <section className="w-full py-12 bg-gradient-to-b min-h-screen">
        ...
        {visibleCount < WORKS.length && (
          <div className="flex justify-center mt-10">
            <button
              ...
              className="px-6 py-2 rounded-lg bg-yellow-500 hover:bg-yellow-600 text-black font-semibold shadow-lg"
            >
              Load More
            </button>
          </div>
